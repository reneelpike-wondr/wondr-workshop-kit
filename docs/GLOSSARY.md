...
**Browser Automation**
When your Sidekick controls your web browser — opening websites, clicking buttons, filling in forms — without you having to touch anything. Like having someone sit at your computer and do things for you.
...
**CLAUDE.md**
A file that tells Claude who it is, how to behave, and what it can do. Think of it like a job description for your Sidekick. Every time Claude Code starts, it reads this file first.
...
**Playwright**
A tool that lets your Sidekick control your browser — opening pages, clicking buttons, taking screenshots. Essential for the hands-off setup experience. Once installed, your assistant can do things like "open their pricing page and screenshot it."

**Prompt**
What you type to your Sidekick. The better your prompt (the more context and detail you give), the better the output. "Write an email" is a bad prompt. "Write a 100-word follow-up email to a café owner who attended my workshop" is a great prompt.
...
**Server**
A computer that runs 24/7 in a data centre. If you want your Sidekick to work while your laptop is closed — sending emails overnight, monitoring leads while you sleep — you need a server. Not required to get started.
...
A free app made by Microsoft. It is where you will chat with your Sidekick, see your files, and run your terminal. Think of it like a supercharged Notepad — most professional developers and AI users work in it.
