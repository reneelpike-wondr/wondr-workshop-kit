...
LEVEL 4 — what Wondr can build for you:
...
- **Full guide:** `~/wondr-workshop-kit/docs/COMPLETION-GUIDE.md`
- **Windows guide:** `~/wondr-workshop-kit/docs/WINDOWS-SETUP.md`
- **Skills reference:** `~/wondr-workshop-kit/docs/SKILLS-REFERENCE.md`
- **Wondr:** wondragency.com.au
- **Email:** hello@wondragency.com.au
